    ...
    <main className="min-h-screen bg-paper-alt px-6 py-16 sm:px-10">
      <div className="mx-auto max-w-3xl">
        <div className="flex items-center gap-2 font-mono-ui text-xs uppercase tracking-widest text-ink-faint">
          <span className="text-amber">◈</span> Nuku OS — {demoWorkspace.account.name}
        </div>

        <div className="mt-3 inline-flex items-center gap-2 rounded-full bg-amber-soft px-3 py-1 font-mono-ui text-[11px] uppercase tracking-widest text-amber">
          Modo demo — Fase 0
        </div>
            ...
            >
              ...
              <div className="flex items-center gap-4">
                ...
                <button
                  ...
                  className="shrink-0 rounded-lg bg-indigo px-5 py-2.5 text-sm font-medium text-paper transition-opacity hover:opacity-90"
                >
